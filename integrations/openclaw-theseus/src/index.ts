    ...
    api.registerTool(
      {
        ...
        async execute(_toolCallId, params: ProposalToolParams, signal) {
          ...
          const reviewedWeek = deriveReviewedWeek(
            params.targetWeekStart,
            params.targetWeekEnd,
          );
          return jsonResult(
